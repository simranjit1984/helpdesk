                ...
                <div className="flex w-full max-w-sm flex-col gap-6">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      disabled={isSaving}
                      className="flex w-full rounded-[2px] border border-bluegrey-500 bg-white px-2 py-3 text-sm text-bluegrey-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      readOnly
                      className="flex w-full rounded-[2px] border border-bluegrey-100 bg-white px-2 py-3 text-sm text-bluegrey-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 cursor-text"
                    />
                  </div>
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-1">
                          ...
                          <input
                            ...
                            onChange={handleFormChange}
                            disabled={isSaving}
                            className="flex w-full rounded-[2px] border border-bluegrey-500 bg-white px-2 pr-10 py-3 text-sm text-bluegrey-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                          />
                        </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="flex w-full rounded-[2px] border border-bluegrey-500 bg-white px-2 py-3 text-sm text-bluegrey-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
                {reauthError && (
