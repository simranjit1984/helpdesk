  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-16 bg-white shadow-[0_2px_4px_0_rgba(1,5,50,0.04),0_4px_5px_0_rgba(1,5,50,0.04),0_1px_10px_0_rgba(1,5,50,0.08)] z-50">
      <div className="flex items-center justify-between h-full px-3">
        <div className="flex items-center gap-12 h-full">
          <div className="flex items-center gap-4 h-full py-3">
            <div className="flex items-center gap-2 h-10">
              <div className="w-32 h-16 flex items-center justify-center text-primary font-bold text-xl">
                INSIDR
              </div>
            </div>
          </div>

          <div className="h-10 w-px bg-bluegrey-100" />

          <button className="flex items-center gap-2 h-10 px-3 rounded-sm hover:bg-bluegrey-25 transition-colors">
        ...
        <div className="flex items-center gap-4 h-10 pl-4">
          <button className="h-10 px-3 rounded-sm hover:bg-bluegrey-25 transition-colors">
