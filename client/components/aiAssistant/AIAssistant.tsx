      ...
      <div className="border-t border-bluegrey-200 p-3 flex-shrink-0 bg-white">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask..."
            className="flex-1 rounded-lg border border-bluegrey-300 px-3 py-2 text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          />
          <button
